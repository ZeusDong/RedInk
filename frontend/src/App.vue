<template>
  <div id="app">
    <!-- 侧边栏 Sidebar -->
    <aside class="layout-sidebar" :class="{ collapsed: layoutStore.sidebarCollapsed }">
      <div class="logo-area">
      ...
      <nav class="nav-menu">
        ...
        <RouterLink to="/reference" class="nav-item" active-class="active">
          ...
          <span class="nav-text">对标文案</span>
        </RouterLink>
        <RouterLink to="/analysis" class="nav-item" active-class="active">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"></path><rect x="9" y="3" width="6" height="4" rx="1"></rect><path d="M9 14l2 2 4-4"></path></svg>
          <span class="nav-text">对标分析</span>
        </RouterLink>
        <RouterLink to="/summary" class="nav-item" active-class="active">
      ...
      <div class="sidebar-footer">
        <!-- 折叠/展开按钮 -->
        <button class="collapse-btn" @click="layoutStore.toggleSidebar" :title="layoutStore.sidebarCollapsed ? '展开菜单' : '收起菜单'">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <polyline v-if="!layoutStore.sidebarCollapsed" points="11 17 6 12 11 7"></polyline>
            <polyline v-else points="13 7 18 12 13 17"></polyline>
            <polyline v-if="!layoutStore.sidebarCollapsed" points="19 17 14 12 19 7"></polyline>
            <polyline v-else points="5 17 10 12 5 7"></polyline>
          </svg>
        </button>
    ...
    <!-- 主内容区 -->
    <main class="layout-main" :class="{ expanded: layoutStore.sidebarCollapsed }">
